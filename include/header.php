            ...
            <div class="main-nav secondary-nav hover-primary-nav py-2">
                <div class="container">
                    <div class="row">
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item"> <a class="nav-link" href="submitproperty.php">Add Property</a> </li>
                                                 <li class="nav-item"> <a class="nav-link" href="contactus.php">User Queries</a> </li>
                        ...
                        &nbsp;&nbsp;<a style="color: #25d366;" href="https://api.whatsapp.com/send/?phone=919021890099&text&type=phone_number&app_absent=0" role="button">
